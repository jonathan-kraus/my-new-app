...
export const greenEStops: MBTAStop[] = [
  ...
  { id: "place-brmnl", type: "stop", attributes: { name: "Brigham Circle" } },
  {
    id: "place-lngmd",
    type: "stop",
    attributes: { name: "Longwood Medical Area" },
  },
  {
    id: "place-mfa",
    type: "stop",
    attributes: { name: "Museum of Fine Arts" },
  },
  {
    id: "place-nuniv",
    type: "stop",
    attributes: { name: "Northeastern University" },
  },
...
/** Lines serving each stop id, e.g. "place-pktrm" -> ["Red", "Green-B", ...]. */
