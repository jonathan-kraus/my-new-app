...
export type UserRoleOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"email" | "role", ExtArgs["result"]["userRole"]>
...
export interface UserRoleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const userRoleWithEmailOnly = await prisma.userRole.findMany({ select: { email: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many UserRoles and only return the `email`
   * const userRoleWithEmailOnly = await prisma.userRole.createManyAndReturn({
   *   select: { email: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more UserRoles and only return the `email`
   * const userRoleWithEmailOnly = await prisma.userRole.updateManyAndReturn({
   *   select: { email: true },
   *   where: {
   *     // ... provide filter here
   *   },
