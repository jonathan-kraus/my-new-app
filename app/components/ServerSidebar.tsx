	...
	return (
		<aside className="w-72 bg-gradient-to-b from-blue-600 via-blue-700 to-indigo-900 text-white shadow-2xl min-h-screen flex flex-col z-40 border-r border-blue-400/50 backdrop-blur-xl">
			...
			<nav className="flex-1 p-4 space-y-2 mt-4">
				...
				<Link
					href="/"
					className="flex items-center space-x-4 px-5 py-4 rounded-2xl backdrop-blur-xl font-semibold text-white transition-all duration-300 border border-transparent hover:border-white/40 hover:scale-[1.02] shadow-lg hover:shadow-xl group bg-white/20 border-white/40 ring-2 ring-white/30"
				>
					<svg
				...
				<Link
					href="/forecast"
					className="flex items-center space-x-4 px-5 py-4 rounded-2xl backdrop-blur-xl font-semibold text-white transition-all duration-300 border border-transparent hover:border-white/40 hover:scale-[1.02] shadow-lg hover:shadow-xl group hover:bg-white/20"
				>
					<svg
						className="w-6 h-6 flex-shrink-0"
						fill="none"
