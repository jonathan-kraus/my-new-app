...
export function EnvironmentStatus() {
  ...
  <section className="border rounded-lg p-4">
    ...
    <div className="space-y-1">
      <p><strong>Project:</strong> {vercel.project?.name}</p>
      <p><strong>TeamId:</strong> {vercel.project?.TeamId}</p>
      <p><strong>Latest Deployment:</strong> {vercel.latestDeployment?.url}</p>
      <p><strong>Status:</strong> {vercel.latestDeployment?.state}</p>
      <p><strong>Commit:</strong> {vercel.latestDeployment?.meta?.githubCommitMessage}</p>
    </div>
  </section>
)}
