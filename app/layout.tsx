// app/layout.tsx - FULL AUTH STATES
"use client";
	...
	return (
		<div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/50 sticky top-6">
			<div className="text-center">
				...
				<h2 className="text-2xl font-bold text-gray-900 mb-2">{session.user?.name || "User"}</h2>
				...
				<div className="max-w-7xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-12 gap-8">
					...
					<aside className="lg:col-span-3 space-y-6">
						...
						<div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/50 space-y-2">
							<a
								href="/"
								className="block p-4 rounded-xl bg-blue-500 text-white font-semibold shadow-md hover:bg-blue-600 transition-all"
							>
								🏠 Home
							</a>
							<a
								href="/notes"
								className="block p-4 rounded-xl bg-purple-500 text-white font-semibold shadow-md hover:bg-purple-600 transition-all"
							>
								📝 Notes
							</a>
							<a
								href="/forecast"
								className="block p-4 rounded-xl bg-indigo-500 text-white font-semibold shadow-md hover:bg-indigo-600 transition-all"
							>
								📁 Forecast
							</a>
							<a href="/logs" className="block p-4 rounded-xl bg-gray-500 text-white font-semibold">
								📊 Logs
							</a>
							<a
								href="/weather-maps"
								className="block p-4 rounded-xl bg-emerald-500 text-white font-semibold shadow-md hover:bg-emerald-600 transition-all"
							>
								🌤️ Weather
							</a>
						</div>
